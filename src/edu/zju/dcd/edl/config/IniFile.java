...
public class IniFile {
	public static final String ARRAY_VALUE_SPLIT_MARK = ";";
	...
	public class Section {
		...
		public String[] getArrayValue(String key) {
			return keyValues.get(key).split(ARRAY_VALUE_SPLIT_MARK);
		}
		...
		public int[] getIntArrayValue(String key) {
			String[] svals = keyValues.get(key).split(ARRAY_VALUE_SPLIT_MARK);
